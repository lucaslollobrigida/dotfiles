...
require("packer").startup(function(use)
  ...
  require("modules.autocomplete").plugins(use)
  require("modules.lang.clojure").plugins(use)
  require("modules.lang.dart").plugins(use)
  require("modules.lang.go").plugins(use)
  require("modules.lang.java").plugins(use)
  require("modules.lang.markdown").plugins(use)
  require("modules.lang.python").plugins(use)
...
require("modules.autocomplete").lazy_load(require_plugin)
...
require("modules.lang.java").lazy_load(require_plugin)
require("modules.lang.markdown").lazy_load(require_plugin)
require("modules.lang.python").lazy_load(require_plugin)
