return {
  ...
  plugins = function(use)
    use { "tamago324/lir.nvim", opt = true, requires = "kyazdani42/nvim-web-devicons" }
  end,
  setup = function()
    ...
    vim.api.nvim_exec(
      ...
      autocmd!
      autocmd Filetype lir lua require("modules.file_browser").lir_settings()
      augroup END
      ]],
      false
    )
