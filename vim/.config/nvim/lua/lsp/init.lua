...
saga.init_lsp_saga {
    ...
    finder_action_keys = {
        open = '<CR>', vsplit = '<c-v>', quit = '<ESC>', scroll_down = '<C-f>', scroll_up = '<C-b>',
    },
    code_action_keys = {
        quit = '<ESC>', exec = '<CR>'
    },
...
M.buf_set_keymap = function (bufnr, ...) vim.api.nvim_buf_set_keymap(bufnr, ...) end
M.buf_set_option = function(bufnr, ...) vim.api.nvim_buf_set_option(bufnr, ...) end
...
M.on_attach = function(client, bufnr)
  ...
  M.buf_set_keymap(bufnr, 'n', 'gD', '<cmd>lua require("telescope.builtin").lsp_references()<CR>', opts)
